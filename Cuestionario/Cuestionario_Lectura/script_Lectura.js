...
function showQuestions(index) {
    ...
    const fuentePregunta = document.querySelector('.question-Fuente');
    ...
    if (questions[index].fuente) {

        fuentePregunta.textContent = `${questions[index].fuente}`;
        fuentePregunta.style.display = 'block';
    } else {
        fuentePregunta.style.display = 'none'; // Ocultar el contenedor de la fuente si no hay fuente disponible
    }
